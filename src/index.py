...
async def scrape_monsters():
    ...
    monsterurl = "Monsters%20List#content"
    links = []
    http = urllib3.PoolManager()

    soup = BeautifulSoup((http.request('GET', baseurl + monsterurl)).data, "html.parser")
    allString = soup.find_all(class_="legendary-actions")
    links = []
...
if __name__ == "__main__":
    ...
    loop.run_until_complete(scrape_monsters())
